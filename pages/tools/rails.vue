...
const rawInput = ref('')
const text = useStorage('payload:text', '')
...
<template>
  <div class="min-h-full px-4 py-6">
    <PageTitle class="uppercase" title="Rails" size="lg" :display="true" />
    <div class="space-y-4">
      <div>
        <label class="block mb-1 text-sm">Paste Ciphertext</label>
        <textarea v-model="rawInput" rows="4" class="w-full p-2 font-mono border-1"></textarea>
      </div>
